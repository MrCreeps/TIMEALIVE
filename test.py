...
GAME_MUSIC_PATH = f"C:/Users/{username}/.CarrierPigeonDevGames/TIMEALIVE/timealive_game.mp3"
...
class Game:
    ...
    def titlescreen(self):
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if pygame.Rect(BUTTON_POSITION, BUTTON_SIZE).collidepoint(mouse_pos):
                        return True
                    if pygame.Rect(OPTIONS_MENU_BUTTON_POSITION, BUTTON_SIZE).collidepoint(mouse_pos):
                        self.options_menu()
            ...
            self.draw_button("Options", FONT, pos=OPTIONS_MENU_BUTTON_POSITION)
    ...
    def options_menu(self):
        ...
        while True:
            ...
            self.draw_button(f"Music: {music_status})", FONT, pos=BUTTON_POSITION)
            self.draw_button("Back to Title", FONT, pos=OPTIONS_MENU_BUTTON_POSITION)
...
# Code by MrCreeps
# Assisted by ChatGPT (haha)
# Cool music by Logan Beaver
